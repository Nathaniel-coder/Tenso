                                ...
                                <div class="card-body pt-0">
                                    <div class="row">
                                        ...
                                        <div class="col-5 text-center">
                                            <img src="/img/user2-160x160.jpg" alt="user-avatar"
                            ...
                            <div class="card bg-light d-flex flex-fill">
                                ...
                                <div class="card-body pt-0">
                                    <div class="row">
                                        ...
                                        <div class="col-5 text-center">
                                            <img src="/img/user5-128x128.jpg" alt="user-avatar"
                                                class="img-circle img-fluid" />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card bg-light d-flex flex-fill">
                                ...
                                <div class="card-body pt-0">
                                    <div class="row">
                                        ...
                                        <div class="col-5 text-center">
                                            <img src="/img/user6-128x128.jpg" alt="user-avatar"
                                                class="img-circle img-fluid" />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card bg-light d-flex flex-fill">
                                ...
                                <div class="card-body pt-0">
                                    <div class="row">
                                        ...
                                        <div class="col-5 text-center">
                                            <img src="/img/user7-128x128.jpg" alt="user-avatar"
                                                class="img-circle img-fluid" />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card bg-light d-flex flex-fill">
                                ...
                                <div class="card-body pt-0">
                                    <div class="row">
                                        ...
                                        <div class="col-5 text-center">
                                            <img src="/img/user4-128x128.jpg" alt="user-avatar"
                                                class="img-circle img-fluid" />
                                        </div>
                                    </div>
                                </div>
