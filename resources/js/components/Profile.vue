                    ...
                    <div class="col-md-7">
                        ...
                        <div class="card card-widget widget-user">
                            ...
                            <div class="widget-user-header text-white"
                                style="background: url('/img/photo2.png') center right;">
                    ...
                    <div class="col-md-5">
                        <div class="card card-info elevation-2">
                            ...
                            <div class="card-body">
                                ...
                                <p class="text-muted">{{ this.form.address1 }},<br> {{ this.form.address2 }},<br> {{ this.form.postcode }} {{ this.form.city }},<br> {{ this.form.province }}, {{ this.form.country }}</p>
                                <hr>
                                ...
                                <hr>
                                <strong><i class="fa fa-cart-shopping"></i> Purchases</strong>
                                    <p class="text-muted nav-link pointer" @click="RIC()">
                                        DropOff : {{ dropOffCount }} <br>
                                        PickUp : {{ pickUpCount }}
                                    </p>
                            </div>
                        </div>
...
export default {
    ...
    created() {
        ...
        Axios.get("api/dropOffCount").then(({ data }) => this.dropOffCount = data);
        Axios.get("api/pickUpCount").then(({data}) => this.pickUpCount = data);
    }
}
</script>
